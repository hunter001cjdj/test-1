...
<body>
    ...
    <main>
        ...
        <div class="image-container">
            <a href="search-station-output\search-zhongshan-output.php?keyword=早餐">
                <img src="photo/breakfast.jpg" alt="早餐">
            </a>
            <a href="search-station-output\search-zhongshan-output.php?keyword=午餐">
                <img src="photo/lunch.jpg" alt="午餐">
            </a>
            <a href="search-station-output\search-zhongshan-output.php?keyword=晚餐">
